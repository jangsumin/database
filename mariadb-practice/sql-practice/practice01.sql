...
select concat(last_name, " ", first_name) from employees where emp_no = 10944;
...
-- select * from employees where emp_no = 13250;
select title as '직책 변경 상황' from titles t
	join employees e on (t.emp_no = e.emp_no)
    where e.emp_no = 13250 and first_name = 'Zeydy'
